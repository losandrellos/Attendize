                                            ...
                                            <div class="ticket-pricing" style="margin-right: 20px;">
                                                ...
                                                @else
                                                    ...
                                                    <span class="tax-amount text-muted text-smaller">
                                                        @if($event->organiser->tax_name && $event->organiser->tax_value)
                                                            @if($event->organiser->tax_included)
                                                                {{'(inc. '.money(($ticket->total_price-($ticket->total_price/($event->organiser->tax_value/100+1))), $event->currency).' '.$event->organiser->tax_name.')' }}
                                                            @else
                                                                {{'('.money(($ticket->total_price*($event->organiser->tax_value)/100), $event->currency).' '.$event->organiser->tax_name.')' }}
                                                            @endif
                                                        @endif
                                                    </span>

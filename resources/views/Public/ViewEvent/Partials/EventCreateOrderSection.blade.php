    ...
    <div class="row">
        ...
        <div class="col-md-8 col-md-pull-4">
            <div class="event_order_form">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <div class="custom-radio">
                                {!! Form::radio('is_business', false, false, ['id' => 'radio_is_private']) !!}
                                {!! Form::label('radio_is_private', trans("Public_ViewEvent.radio_is_private"), ['class' => 'control-label']) !!}
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row hidden" id="private_details">
                    <div class="col-md-12">
                        <div class="form-group">
                            <div class="row">
                                <div class="col-xs-6">
                                    <div class="form-group">
                                        {!! Form::label("private_business_name", trans("Public_ViewEvent.private_business_name")) !!}
                                        {!! Form::text("private_business_name", null, ['class' => 'form-control']) !!}
                                    </div>
                                </div>
                                <div class="col-xs-6">
                                    <div class="form-group">
                                        {!! Form::label("private_business_tax_number", trans("Public_ViewEvent.private_business_tax_number")) !!}
                                        {!! Form::text("private_business_tax_number", null, ['class' => 'form-control']) !!}
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    {!! Form::Label('country_dropdown', 'Country:') !!}
                                    <select class="form-control{{ $errors->has('country_dropdown') ? ' is-invalid' : '' }}"
                                    ...
                                    @if ($errors->has('country_dropdown'))
                            ...
                            <div class="row hidden" id="pec_destination_code">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        {!! Form::label('pec_destination_code', trans("Public_ViewEvent.pec_destination_code")) !!}
                                        <div class="custom-radio">
                                            {!! Form::radio("pec_destination_code", true, true, ['id' => 'radio_pec']) !!}
                                            {!! Form::label('radio_pec', trans("Public_ViewEvent.radio_pec"), ['class' => 'control-label']) !!}
                                        </div>
                                        <div class="custom-radio">
                                            {!! Form::radio('pec_destination_code', false, false, ['id' => 'radio_destination_code']) !!}
                                            {!! Form::label('radio_destination_code', trans("Public_ViewEvent.radio_destination_code"), ['class' => 'control-label']) !!}
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-12" id="pec">
                                    <div class="form-group">
                                        {!! Form::label('pec', trans("Public_ViewEvent.pec")) !!}
                                        {!! Form::text("pec", null, ['class' => 'form-control']) !!}
                                    </div>
                                </div>
                                <div class="col-md-12 hidden" id="destination_code">
                                    <div class="form-group">
                                        {!! Form::label('destination_code', trans("Public_ViewEvent.destination_code")) !!}
